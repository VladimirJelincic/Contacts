var app = angular.module('codecraft',
    ['ngResource',
        'infinite-scroll', 'angularSpinner', 'jcs-autoValidate',
        'angular-ladda', 'mgcrea.ngStrap', "toaster", 'ngAnimate',
        'ui.router']);
...
app.controller('PersonListController', function ($scope, $modal, $rootScope, ContactService) {
